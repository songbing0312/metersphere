...
public class WorkspaceService {
    ...
    @Resource
    private SystemProjectService projectService;
    @Resource
    ...
    public List<WorkspaceDTO> getAllWorkspaceList(WorkspaceRequest request) {
        ...
        return baseWorkspaceMapper.getWorkspaces(request);
    }
    ...
    public void updateWorkspaceMember(WorkspaceMemberDTO memberDTO) {
        ...
        // 已有角色
        List<Group> memberGroups = baseUserGroupMapper.getWorkspaceMemberGroups(workspaceId, userId);
        // 修改后的角色
